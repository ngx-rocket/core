...
describe('FileUtilities', () => {
  ...
  describe('_getConditions', () => {
    ...
    it('should return a single condition', () => {
      const result = FileUtilities._getConditions(
        '__condition.some-file.js',
        '__'
      );
    ...
    it('should return a single condition', () => {
      const result = FileUtilities._getConditions(
        '__condition(action).some-file.js',
        '__'
      );
      expect(result).toEqual(['condition']);
    });
  ...
  describe('_checkConditions', () => {
    ...
    it('should return true', () => {
      const result = FileUtilities._checkConditions(
        ['a', 'c'],
        {props: {in: true}},
        rules
      );
  ...
  describe('_getAction', () => {
    ...
    it('should return an action', () => {
      const result = FileUtilities._getAction(
        '__condition(action).some-file.js'
      );
      expect(result).toEqual('action');
    });
