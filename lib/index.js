...
class CoreGenerator extends Generator {
  ...
  static make(options) {
    ...
    return class extends CoreGenerator {
      constructor(args, opts) {
        ...
        if (generatorBase) {
          const methods = Object.getOwnPropertyNames(generatorBase.prototype)
  ...
  static get sharedProps() {
    return _.assign({}, CoreGenerator._sharedProps);
  }
   ...
   */
  static set sharedProps(props) {
    _.defaults(CoreGenerator._sharedProps, props);
  }
  ...
  set sharedProps(props) {
    CoreGenerator.sharedProps = props;
  }
    ...
    return new Promise((resolve) => {
      dir.files(this._templatesPath, (err, files) => {
        ...
        this.files = _.map(files, (file) => {
          let src = path.relative(this._templatesPath, file);
